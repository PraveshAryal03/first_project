...
class _LogFoodPageState extends State<LogFoodPage> {
  ...
  final List<FoodItem> foodItems = const [
    ...
    FoodItem(
      ...
      caloriesPerUnit: 62,
      assetPath: 'assets/images/orange.jpg',
      proteinG: 1.2,
      carbsG: 15.4,
      fatsG: 0.2,
    ),
    FoodItem(
      name: 'Strawberries (100 g)',
      caloriesPerUnit: 32,
      assetPath: 'assets/images/strawberries.jpg',
      proteinG: 0.7,
      carbsG: 7.7,
      fatsG: 0.3,
    ),
    FoodItem(
      ...
      caloriesPerUnit: 57,
      assetPath: 'assets/images/blueberries.jpg',
      proteinG: 0.7,
      carbsG: 14.5,
      fatsG: 0.3,
    ),
    FoodItem(
      name: 'Avocado (1/2)',
      caloriesPerUnit: 120,
      assetPath: 'assets/images/avocado.jpg',
      proteinG: 1.5,
      carbsG: 6.0,
      fatsG: 10.5,
    ),
    ...
    FoodItem(
      name: 'Broccoli (100 g)',
      caloriesPerUnit: 55,
      assetPath: 'assets/images/broccoli.jpg',
      proteinG: 3.7,
      carbsG: 11.2,
      fatsG: 0.6,
    ),
    FoodItem(
      name: 'Spinach (100 g)',
      caloriesPerUnit: 23,
      assetPath: 'assets/images/spinach.jpg',
      proteinG: 2.9,
      carbsG: 3.6,
      fatsG: 0.4,
    ),
    FoodItem(
      name: 'Carrots (100 g)',
      caloriesPerUnit: 41,
      assetPath: 'assets/images/carrots.jpg',
      proteinG: 0.9,
      carbsG: 9.6,
      fatsG: 0.2,
    ),
    FoodItem(
      ...
      caloriesPerUnit: 86,
      assetPath: 'assets/images/sweet_potato.jpg',
      proteinG: 1.6,
      carbsG: 20.1,
      fatsG: 0.1,
    ),
    ...
    FoodItem(
      name: 'Pasta (100 g cooked)',
      caloriesPerUnit: 131,
      assetPath: 'assets/images/pasta.jpg',
      proteinG: 5.0,
      carbsG: 25.0,
      fatsG: 1.1,
    ),
    FoodItem(
      ...
      caloriesPerUnit: 120,
      assetPath: 'assets/images/quinoa.jpg',
      proteinG: 4.4,
      carbsG: 21.3,
      fatsG: 1.9,
    ),
    FoodItem(
      ...
      caloriesPerUnit: 158,
      assetPath: 'assets/images/oatmeal.jpg',
      proteinG: 6.0,
      carbsG: 27.0,
      fatsG: 3.2,
    ),
    FoodItem(
      ...
      caloriesPerUnit: 80,
      assetPath: 'assets/images/whole_wheat_bread.jpg',
      proteinG: 4.0,
      carbsG: 14.0,
      fatsG: 1.0,
    ),
    ...
    FoodItem(
      ...
      caloriesPerUnit: 165,
      assetPath: 'assets/images/chicken_breast.jpg',
      proteinG: 31.0,
      carbsG: 0.0,
      fatsG: 3.6,
    ),
    FoodItem(
      name: 'Chicken Thigh (100 g)',
      caloriesPerUnit: 209,
      assetPath: 'assets/images/chicken_thigh.jpg',
      proteinG: 26.0,
      carbsG: 0.0,
      fatsG: 10.9,
    ),
    FoodItem(
      name: 'Turkey Breast (100 g)',
      caloriesPerUnit: 135,
      assetPath: 'assets/images/turkey_breast.jpg',
      proteinG: 29.0,
      carbsG: 0.0,
      fatsG: 1.0,
    ),
    FoodItem(
      name: 'Beef Steak (100 g)',
      caloriesPerUnit: 271,
      assetPath: 'assets/images/beef_steak.jpg',
      proteinG: 25.0,
      carbsG: 0.0,
      fatsG: 19.0,
    ),
    FoodItem(
      name: 'Pork Chop (100 g)',
      caloriesPerUnit: 231,
      assetPath: 'assets/images/pork_chop.jpg',
      proteinG: 26.0,
      carbsG: 0.0,
      fatsG: 14.0,
    ),
    FoodItem(
      name: 'Salmon (100 g)',
      caloriesPerUnit: 208,
      assetPath: 'assets/images/salmon.jpg',
      proteinG: 20.0,
      carbsG: 0.0,
      fatsG: 13.0,
    ),
    FoodItem(
      name: 'Tuna (100 g)',
      caloriesPerUnit: 132,
      assetPath: 'assets/images/tuna.jpg',
      proteinG: 29.0,
      carbsG: 0.0,
      fatsG: 1.0,
    ),
    FoodItem(
      name: 'Shrimp (100 g)',
      caloriesPerUnit: 99,
      assetPath: 'assets/images/shrimp.jpg',
      proteinG: 24.0,
      carbsG: 0.2,
      fatsG: 0.3,
    ),
    FoodItem(
      name: 'Tofu (100 g)',
      caloriesPerUnit: 76,
      assetPath: 'assets/images/tofu.jpg',
      proteinG: 8.0,
      carbsG: 1.9,
      fatsG: 4.8,
    ),
    FoodItem(
      name: 'Boiled Egg (1)',
      caloriesPerUnit: 78,
      assetPath: 'assets/images/boiled_egg.jpg',
      proteinG: 6.0,
      carbsG: 0.6,
      fatsG: 5.3,
    ),
    ...
    FoodItem(
      name: 'Greek Yogurt (170 g)',
      caloriesPerUnit: 100,
      assetPath: 'assets/images/greek_yogurt.jpg',
      proteinG: 17.0,
      carbsG: 6.0,
      fatsG: 0.7,
    ),
    FoodItem(
      ...
      caloriesPerUnit: 98,
      assetPath: 'assets/images/cottage_cheese.jpg',
      proteinG: 11.0,
      carbsG: 3.4,
      fatsG: 4.3,
    ),
    FoodItem(
      ...
      caloriesPerUnit: 94,
      assetPath: 'assets/images/peanut_butter.jpg',
      proteinG: 3.5,
      carbsG: 3.2,
      fatsG: 8.0,
    ),
    FoodItem(
      name: 'Almonds (28 g)',
      caloriesPerUnit: 164,
      assetPath: 'assets/images/almonds.jpg',
      proteinG: 6.0,
      carbsG: 6.0,
      fatsG: 14.0,
    ),
  ...
  void _logFood(FoodItem item) {
    ...
    context.read<CalorieTrackerProvider>().addMeal(
      ...
      quantity: qty,
      proteinPerUnit: item.proteinG.toInt(),
      carbsPerUnit: item.carbsG.toInt(),
      fatsPerUnit: item.fatsG.toInt(),
    );
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Logged $qty × ${item.name} • $totalK kcal • P $totalP / C $totalC / F $totalF g',
        ),
      ),
    );
